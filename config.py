...
# Fractal N-bar pivot detection: จำนวนแท่งรอบข้างที่ใช้ยืนยัน swing point
# N ยิ่งใหญ่ = swing ยิ่งสำคัญ แต่หาได้น้อยลง
FRACTAL_N = {
    'M1': 2,   # Fast TF - ใช้ N เล็ก
    'M5': 3,
    'M15': 3,
    'M30': 3,
    'H1': 5,   # Slow TF - ใช้ N ใหญ่
    'H4': 5
}
